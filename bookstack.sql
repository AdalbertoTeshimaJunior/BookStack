...
ALTER TABLE `utiliza`
  ...
  ADD CONSTRAINT `utiliza_ibfk_2` FOREIGN KEY (`codigo_usuario`) REFERENCES `usuario` (`codigo`),
  ADD CONSTRAINT `utiliza_ibfk_3` FOREIGN KEY (`codigo_livro`) REFERENCES `livro` (`codigo`),
